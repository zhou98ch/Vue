...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      showGameOverScene () {
        Constant.Event.$emit(Constant.MSG_OVER_GAME_SCENE, this.youWin)
      },
      ...
      cardCClick () {
       ...
       randomizeEnergy () {
        this.userCardPower = Math.round(Math.random() * 50) + 50
        this.battleCardPower = Math.round(Math.random() * 50) + 50
